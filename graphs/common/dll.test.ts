...
import { DLL } from "./dll";
import { IndexError } from "./dll";

describe("push", function () {
  it("appends and updates", function () {
    const lst = new DLL<number>();
...
describe("removeAt", function () {
  it("removes items from list", function () {
    const lst = new DLL<number>([5, 10, 15, 20]);
